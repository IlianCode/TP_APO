...
public class Jeu {
    ...
    void afficheCarteJoueur(PlaceJoueur joueur, Carte carte) {
        ...
        String imagePath;
        imagePath = "../images/" + carte.getFichierImage();
        System.out.println(imagePath);
        if(joueur == PlaceJoueur.GAUCHE){

            carteJoueurGaucheLabel.setIcon(new ImageIcon(imagePath));
        }else {
            carteJoueurDroiteLabel.setIcon(new ImageIcon(imagePath));
        }   
    ...
    void jouer() {
        bataille.distribue();
        afficheCarteJoueur(PlaceJoueur.GAUCHE, bataille.joueurGauche.carte);
        afficheCarteJoueur(PlaceJoueur.DROITE, bataille.joueurDroite.carte);

        commentaire.setText("" + bataille.joueurGauche.getNom() + " joue un(e) " + bataille.joueurGauche.carte.toString() + " || " +bataille.joueurDroite.getNom() + " joue un(e) " + bataille.joueurDroite.carte.toString());
    ...
    void remporter() {
        ...
        Joueur res = bataille.gagnant();
        if (res == null ){
            commentaire.setText("Bataille ! on rejoue...");
        }else{
            commentaire.setText("C'est le joueur " + res.getNom() + " qui remporte le pli.");
        }
