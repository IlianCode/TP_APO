...
public class BeloteInterface {
    ...
    void remporter() {
        ...
        String msg = "<html>";
        msg += "C'est " + gagnant.nom + " avec son " + gagnant.carte.toString();
    ...
    void afficheCarteJoueur(JoueurPosition position, Carte carte) {
        ...
        switch(position) {
            case NORD:
                carteLabel = carteJoueurNordLabel;
                break;
            case SUD:
                carteLabel = carteJoueurSudLabel;
                break;
            case EST:
                carteLabel = carteJoueurEstLabel;
                break;
            case OUEST:
                carteLabel = carteJoueurOuestLabel;
                break;
            default:
                break;
        }
    ...
    void setJoueurPoints(JoueurPosition position, String nom, int points) {
        ...
        switch(position) {
            case NORD:
                joueurLabel = labelJoueurNord;
                break;
            case SUD:
                joueurLabel = labelJoueurSud;
                break;
            case EST:
                joueurLabel = labelJoueurEst;
                break;
            case OUEST:
                joueurLabel = labelJoueurOuest;
                break;
            default:
                break;
        }
    ...
    void initFrame() {
        ...
        frameJeuDeBelotte.getContentPane().setLayout(new BoxLayout(frameJeuDeBelotte.getContentPane(), BoxLayout.Y_AXIS));
        // Jeu
        // Joueurs
